...
START_MONEY = 5000; 			// Dinheiro inicial para quem ainda não ganhou nada.

// Arsenal ///////////////////////////////////////////////////////////////////////////////////////////////////////
NAME_OF_THE_ARMORY = caixa01; 	// Nome do objeto que servirá como arsenal. deve estar no mapa.
NAME_OF_THE_ATM = atm;

ARSENAL_COST = 350;			// Custo de acesso ao Arsenal
